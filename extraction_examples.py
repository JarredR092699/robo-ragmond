...
def process_content_for_chromadb(content: str, url: str) -> list:
    ...
    # Split content into meaningful chunks (not just by character count)
...
async def main():
    ...
    # Define URLs to crawl (from extraction_examples.py)
    urls_to_crawl = [
